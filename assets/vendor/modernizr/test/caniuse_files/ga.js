(function() {
    ...
    var T = function(d, f) {
        ...
        za = function(d) {
            ...
            if (!M(d)) {
                f = 0;
                for (h = d[v] - 1; h >= 0; h--) b = d.charCodeAt(h), f = (f << 6 & 268435455) + b + (b << 14), b = f & 266338304, f = b != 0 ? f ^ b >> 21 :
                    f
            }
            return f
        },
    ...
    var Ga = "https:" == L[w][y][ea] ? "https://ssl.google-analytics.com/" : "http://www.google-analytics.com/",
        ...
        Ja = function() {
            ...
            d.Bb = function(f, b, h, e, m) {
                b[v] <= 2036 || m ? d.Aa(f + "?" + b, e) : b[v] <= 8192 ? L.Xc() ? d.Aa(f + "?" + h + "&err=ff2post&len=" + b[v], e) : d.fd(b, e) : d.Aa(
                    f + "?" + h + "&err=len&max=8192&len=" + b[v], e)
            };
            d.Aa = function(d, b) {
                var h = new Image(1, 1);
                h.src = d;
            ...
            d.ed = function(d, b) {
                ...
                else if (e = L[t].XMLHttpRequest) e = new e, "withCredentials" in e && (h = e, h.open("POST", Ha, !0), h.setRequestHeader(
        ...
        f.A = function(a, c, d, j, i, s) {
            ...
            if (B[1] < 500 || j) {
                ...
                if (j || !i || B[2] >= 1) {
                    ...
                    if (1 == n || 2 == n) c = "&utmac=" + c, j += c, a += c + "&utmcc=" + f.Tc(d), V.Ab && (d = "&aip=1", j += d, a += d), a +=
                        "&utmu=" + qa.Sc(), m && e.Bb(f.Uc(), a, j, s)
                }
            }
            h.$(B[A]("."));
            h.aa()
    ...
    W.Qc = function(d, f, b, h, e, m) {
        ...
        g.Eb = m;
        g.ha = function() {
            return "&" + ["utmt=item", "tid=" + P(g.Fb), "ipc=" + P(g.va), "ipn=" + P(g.n), "iva=" + P(g.Cb), "ipr=" + P(g.Db), "iqt=" + P(g.Eb)][A]
                ("&utm")
        }
    };
    W.Wc = function(d, f, b, h, e, m, g, a) {
        ...
        c.ha = function() {
            return "&" + ["utmt=tran", "id=" + P(c.q), "st=" + P(c.tb), "to=" + P(c.zb), "tx=" + P(c.yb), "sp=" + P(c.wb), "ci=" + P(c.ub), "rg=" +
                P(c.xb), "co=" + P(c.vb)
            ][A]("&utmt")
        }
    };
    var La = function(d) {
        ...
        b.cc = function() {
            for (var d = L[t].navigator, a = L[t].history[v],
                    d = d.appName + d.version + b.Lb + d.platform + d.userAgent + b.Kb + b.Nb + b.Mb + (L[w][ca] ? L[w][ca] : "") + (L[w].referrer ?
                        L[w].referrer : ""), c = d[v]; a > 0;) d += a-- ^ c++;
            return za(d)
        }
    };
    var Z = function(d, f, b, h) {
        ...
        g.mb = function(a) {
            var c = g.ua();
            return new Z.v(N(a, m.Ea + E, D), N(a, m.Ha + E, D), N(a, m.Ja + E, D), g.R(a, m.Ca, "(not set)"), g.R(a, m.Fa, "(not set)"), g.R(a, m.Ia,
                c && !M(c.G) ? Q(c.G) : k), g.R(a, m.Da, k), N(a, m.vc + E, D))
        };
        g.nb = function(a) {
            var c = e(a),
                b;
        ...
        g.ua = function() {
            ...
            if (!M(c) && "0" != c && R(c, "://") && !g.nb(c)) {
                a = e(c);
                for (var i = 0; i < d[v]; i++)
                    if (b = d[i], R(a, b.ib[C]()) && (c = c[x]("?")[A](D), R(c, D + b.jb + E))) return a = c[x](D + b.jb + E)[1], R(a, D) && (a = a[
                        x](D)[0]), new Z.v(k, b.ib, k, "(organic)", "organic", a, k, k)
            }
        };
        g.R = function(a, c, b) {
            a = N(a, c + E, D);
        ...
        g.lb = function() {
            var a =
                ...
                c = "",
                a = g.ob;
            if (!M(a) && "0" != a && R(a, "://") && !g.nb(a)) return a = a[x]("://")[1], R(a, "/") && (c = a[z](a[q]("/")), c = c[x]("?")[0], a = a[
                x]("/")[0][C]()), 0 == a[q]("www.") && (a = a[z](4)), new Z.v(k, a, k, "(referral)", "referral", k, c, k)
        };
        g.kb = function(a) {
            var c = "";
        ...
        g.Pb = function(a, c) {
            if (m.Ka) {
                ...
                if (a) {
                    ...
                    g.h(e) || M(d) && c && (e = g.ta());
                    if (g.h(e) && (M(d) || (f = d[x]("."), n = new Z.v, n.gb(f.slice(4)[A](".")), n = n.H()[C]() == e.H()[C](), f = f[3] * 1), !n ||
                            c)) h = N(h, F + B + ".", ";"), n = h.lastIndexOf("."), h = n > 9 ? h[z](n + 1) * 1 : 0, f++, h = 0 == h ? 1 : h, a.ra(
                        [B, g.m, h, f, e.H()][A](".")), a.sa()
                }
            }
        }
    };
    ...
    var Qa = function(d, f, b) {
        ...
        a.nc = function() {
            ...
            M(s) ? h ? (s = !i || !u) ? (s = m(d,
                ";", l(b)), a.F = !0) : (s = N(d, F + e + ".", ";"), G = N(d, H + e, ";")[x](".")) : (s = [e, a.mc(), b, b, b, 1][A]("."), Ia =
                a.F = !0) : M(c.z()) || M(c.ca()) ? (s = m(Y, D, l(b)), a.F = !0) : (G = c.z()[x]("."), e = G[0]);
            s = s[x](".");
            L[t] && f && f.dh == e && !j.o && (s[4] = f.sid ? f.sid : s[4], Ia && (s[3] = f.sid ? f.sid : s[4], f.vid && (b = f.vid[x]("."), s[1] =
                b[0], s[2] = b[1])));
            c.Na(s[A]("."));
            G[0] = e;
            G[1] = G[1] ? G[1] : 0;
        ...
        a.Za = c("_trackEvent", 4, function(b, c, d, e) {
            a.c();
            var f = a.bb;
            k != b && k != c && "" != b && "" != c ? (f.t(5), f.ia(5), (b = f.j(5, 1, b) && f.j(5, 2, c) && (k == d || f.j(5, 3, d)) && (k == e ||
                f.ja(5, 1, e))) && a.qc(f)) : b = !1;
            return b
        });
