        ...
        jQuery.extend({
            ...
            map: function(elems, callback, arg) {
                var value, key, ret = [],
                    ...
                    isArray = elems instanceof jQuery || length !== undefined && typeof length === "number" && ((length > 0 && elems[0] &&
            ...
            if (parts.length > 1 && origPOS.exec(selector)) {
                ...
                if (context) {
                    ret = seed ? {
                        ...
                        Sizzle.find(parts.pop(), parts.length === 1 && (parts[0] === "~" || parts[0] === "+") && context.parentNode ? context.parentNode :
                            context, contextXML);
                    set = ret.expr ?
